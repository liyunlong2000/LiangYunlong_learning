...
![image](https://user-images.githubusercontent.com/56336922/188292694-0e877e15-13f1-4f17-95bf-4569801e0b5a.png)

- 矩阵A的每一行为一个节点的特征
- $W^Q、W^K，W^V$为求Q、K、V的权重矩阵
- 矩阵A和Q、K、V的权重矩阵相乘，得到矩阵Q、K、V
- 矩阵Q、K、V的每一行为相应结点对应的q、k、v值
...
![image](https://user-images.githubusercontent.com/56336922/188292897-a51702ef-00a0-41df-bd08-8ab57fc8ff74.png)

- 计算出来的Q、K、V与矩阵 $W^Q_1、W^K_1，W^V_1$相乘得到对应的矩阵 $Q_1、K_1，V_1$
- 下标代表通过不同头计算得到的结果

![image](https://user-images.githubusercontent.com/56336922/188293011-b8ef29e8-eb9b-4711-b84d-881ffbd06f52.png)

- $Q_1、K_1，V_1$通过注意力计算得到注意力矩阵 $B_1$
- 不同头计算得到的注意力矩阵按图中方式拼接
- 拼接后的矩阵与矩阵$W^O$相乘，得到最终的输出B，每一行为相应节点对应输出特征
